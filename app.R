                        ...
                        column(12, 
                               tags$div(
                                   fluidRow(
                                       ...
                                       column(8,
                                              tags$li(tags$strong("Siyu Chen:"), "A passionate Marketing candidate who tries to explore creative ideas."),
                                              tags$li(tags$strong("Xin Huang:"), "A self-motivated and data-driven Finance candidate with strong analytical skills."), 
                                              tags$li(tags$strong("Tengfei Jiang:"), "A reliable and responsible fast-learner with a comprehensive background in Economics and Marketing."), 
                                              tags$li(tags$strong("Kangni Ren: "), "A graduate student majoring in Marketing Analytics who has strong interests in data visualization."),
                                              tags$li(tags$strong("Yisha Tian: "), "A hardworking marketing student who has an excellent work ethic and great personality.")
                                       )
                                   )
                               ),
                               br(),
